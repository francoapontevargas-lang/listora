...
export default function SignupPage() {
  ...
  if (sent) {
    return (
      <main style={{ minHeight: "100vh", background: BG, display: "flex", alignItems: "center", justifyContent: "center", padding: "32px 24px", fontFamily: "var(--font-dm-sans)" }}>
        <div style={{ width: "100%", maxWidth: "440px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "28px" }}>
          ...
          <div style={{ width: "64px", height: "64px", borderRadius: "50%", background: "rgba(200,169,110,0.08)", border: `1px solid ${BORDER}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "26px" }}>
            ✉
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <p style={{ fontSize: "14px", color: MUTED, margin: 0, lineHeight: 1.6 }}>
              We sent a confirmation link to <span style={{ color: WARM_WHITE }}>{email}</span>. Click it to continue setting up your account.
            </p>
          </div>
