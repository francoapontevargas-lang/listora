...
function statusColor(status: ListingStatus | null) {
      ...
      <aside style={{ width: "240px", flexShrink: 0, borderRight: `1px solid ${BORDER}`, display: "flex", flexDirection: "column", padding: "28px 0", position: "sticky", top: 0, height: "100vh", overflow: "hidden" }}>
        ...
        <div style={{ padding: "16px 12px 0", borderTop: `1px solid ${BORDER}` }}>
          ...
          <button
            ...
            style={{ width: "100%", display: "flex", alignItems: "center", gap: "10px", padding: "10px 14px", borderRadius: "10px", fontSize: "14px", color: MUTED, background: "transparent", border: "none", cursor: "pointer", textAlign: "left", transition: "color 0.15s", fontFamily: "var(--font-dm-sans)" }}
      ...
      <main style={{ flex: 1, padding: "48px 52px", maxWidth: "1000px" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "48px" }}>
          ...
          <Link
            ...
            style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: GOLD, color: BG, fontSize: "14px", fontWeight: 600, padding: "12px 24px", borderRadius: "100px", textDecoration: "none", letterSpacing: "0.01em", flexShrink: 0, marginTop: "8px" }}
          >
            + New Listing
          </Link>
        </div>
...
function ListingCard({ listing }: { listing: Listing }) {
  ...
  const status = (listing.status as ListingStatus) ?? "Active";
  ...
  return (
    ...
    >
      ...
      {/* Price */}
      <p style={{ fontFamily: "var(--font-cormorant)", fontSize: "24px", fontWeight: 400, color: WARM_WHITE, margin: 0, letterSpacing: "-0.01em" }}>
      ...
      <div style={{ display: "flex", gap: "16px" }}>
        {listing.bedrooms != null && (
          <span style={{ fontSize: "13px", color: MUTED }}>
            <span style={{ marginRight: "4px" }}>🛏</span>{listing.bedrooms} bd
          </span>
        )}
        {listing.bathrooms != null && (
          <span style={{ fontSize: "13px", color: MUTED }}>
            <span style={{ marginRight: "4px" }}>🚿</span>{listing.bathrooms} ba
          </span>
        )}
        {listing.area != null && (
          <span style={{ fontSize: "13px", color: MUTED }}>
            <span style={{ marginRight: "4px" }}>⊡</span>{listing.area.toLocaleString()} {listing.area_unit ?? "sqft"}
          </span>
        )}
      </div>
      ...
      <div style={{ display: "flex", gap: "8px", marginTop: "4px" }}>
        <Link
          ...
          style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "9px 16px", borderRadius: "100px", background: GOLD, color: BG, fontSize: "13px", fontWeight: 600, textDecoration: "none", transition: "opacity 0.15s" }}
        ...
        <Link
          ...
          style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "9px 16px", borderRadius: "100px", border: `1px solid ${BORDER}`, color: MUTED, fontSize: "13px", fontWeight: 400, textDecoration: "none", background: "transparent", transition: "color 0.15s, border-color 0.15s" }}
